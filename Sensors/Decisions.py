...
class Decisions:
    ...
    def __init__(self):
        ...
        self.time_songs  = {datetime.datetime(2017,5,28,19,0,0) : ["Transitions/hour.yml", "Dreamfunk.yml"], datetime.datetime(2017,5,28,19,40,0) : ["Transitions/sundown.yml", "strawberry.yml", "space.yml"], datetime.datetime(2017,5,28,20,0,0) : ["Transitions/hour.yml", "SweetChild.yml"], datetime.datetime(2017,5,28,21,0,0) : ["Transitions/hour.yml", "TATRAN - Shvat.yml"], datetime.datetime(2017,5,28,22,0,0) : ["Transitions/hour.yml", "wish.yml"], datetime.datetime(2017,5,28,23,0,0) : ["Transitions/hour.yml", "bao.yml"], datetime.datetime(2017,5,29,0,0,0) : ["Transitions/hour.yml", "Faceplant.yml"], datetime.datetime(2017,5,29,1,0,0) : ["Transitions/hour.yml", "Soul Orchestra.yml"], datetime.datetime(2017,5,29,2,0,0) : ["Transitions/hour.yml", "nisim.yml"], datetime.datetime(2017,5,29,3,0,0) : ["Transitions/hour.yml", "wish.yml"], datetime.datetime(2017,5,29,4,0,0) : ["Transitions/hour.yml", "Faceplant.yml"], datetime.datetime(2017,5,29,5,0,0) : ["Transitions/hour.yml", "space.yml"], datetime.datetime(2017,5,29,5,35,0) : [random.choice(["Transitions/sunrise.yml","Transitions/sunrise_hebrew.yml"]), "wish.yml"], datetime.datetime(2017,5,29,5,45,0) : ["Transitions/after_sunrise.yml", "exile.yml"], \
                            datetime.datetime(2017,5,29,19,0,0) : ["Transitions/hour.yml", "Dreamfunk.yml"], datetime.datetime(2017,5,29,19,40,0) : ["Transitions/sundown.yml", "strawberry.yml", "space.yml"], datetime.datetime(2017,5,29,20,0,0) : ["Transitions/hour.yml", "SweetChild.yml"], datetime.datetime(2017,5,28,21,0,0) : ["Transitions/hour.yml", "TATRAN - Shvat.yml"], datetime.datetime(2017,5,29,22,0,0) : ["Transitions/hour.yml", "wish.yml"], datetime.datetime(2017,5,29,23,0,0) : ["Transitions/hour.yml", "bao.yml"], datetime.datetime(2017,5,30,0,0,0) : ["Transitions/hour.yml", "Faceplant.yml"], datetime.datetime(2017,5,30,1,0,0) : ["Transitions/hour.yml", "Soul Orchestra.yml"], datetime.datetime(2017,5,30,2,0,0) : ["Transitions/hour.yml", "nisim.yml"], datetime.datetime(2017,5,30,3,0,0) : ["Transitions/hour.yml", "wish.yml"], datetime.datetime(2017,5,30,4,0,0) : ["Transitions/hour.yml", "Faceplant.yml"], datetime.datetime(2017,5,30,5,0,0) : ["Transitions/hour.yml", "space.yml"], datetime.datetime(2017,5,30,5,35,0) : [random.choice(["Transitions/sunrise.yml","Transitions/sunrise_hebrew.yml"]), "wish.yml"], datetime.datetime(2017,5,30,5,45,0) : ["Transitions/after_sunrise.yml", "exile.yml"], \
                            datetime.datetime(2017,5,30,19,0,0) : ["Transitions/hour.yml", "Dreamfunk.yml"], datetime.datetime(2017,5,30,19,40,0) : ["Transitions/sundown.yml", "strawberry.yml", "space.yml"], datetime.datetime(2017,5,30,20,0,0) : ["Transitions/hour.yml", "SweetChild.yml"], datetime.datetime(2017,5,28,21,0,0) : ["Transitions/hour.yml", "TATRAN - Shvat.yml"], datetime.datetime(2017,5,30,22,0,0) : ["Transitions/hour.yml", "wish.yml"], datetime.datetime(2017,5,30,23,0,0) : ["Transitions/hour.yml", "bao.yml"], datetime.datetime(2017,5,31,0,0,0) : ["Transitions/hour.yml", "Faceplant.yml"], datetime.datetime(2017,5,31,1,0,0) : ["Transitions/hour.yml", "Soul Orchestra.yml"], datetime.datetime(2017,5,31,2,0,0) : ["Transitions/hour.yml", "nisim.yml"], datetime.datetime(2017,5,31,3,0,0) : ["Transitions/hour.yml", "wish.yml"], datetime.datetime(2017,5,31,4,0,0) : ["Transitions/hour.yml", "Faceplant.yml"], datetime.datetime(2017,5,31,5,0,0) : ["Transitions/hour.yml", "space.yml"], datetime.datetime(2017,5,31,5,35,0) : [random.choice(["Transitions/sunrise.yml","Transitions/sunrise_hebrew.yml"]), "wish.yml"], datetime.datetime(2017,5,31,5,45,0) : ["Transitions/after_sunrise.yml", "exile.yml"], \
                            datetime.datetime(2017,5,31,19,0,0) : ["Transitions/hour.yml", "Dreamfunk.yml"], datetime.datetime(2017,5,31,19,40,0) : ["Transitions/sundown.yml", "strawberry.yml", "space.yml"], datetime.datetime(2017,5,31,20,0,0) : ["Transitions/hour.yml", "SweetChild.yml"], datetime.datetime(2017,5,28,21,0,0) : ["Transitions/hour.yml", "TATRAN - Shvat.yml"], datetime.datetime(2017,5,31,22,0,0) : ["Transitions/hour.yml", "wish.yml"], datetime.datetime(2017,5,31,23,0,0) : ["Transitions/hour.yml", "bao.yml"], datetime.datetime(2017,6,1,0,0,0) : ["Transitions/hour.yml", "Faceplant.yml"], datetime.datetime(2017,6,1,1,0,0) : ["Transitions/hour.yml", "Soul Orchestra.yml"], datetime.datetime(2017,6,1,2,0,0) : ["Transitions/hour.yml", "nisim.yml"], datetime.datetime(2017,6,1,3,0,0) : ["Transitions/hour.yml", "wish.yml"], datetime.datetime(2017,1,1,4,0,0) : ["Transitions/hour.yml", "Faceplant.yml"], datetime.datetime(2017,6,1,5,0,0) : ["Transitions/hour.yml", "space.yml"], datetime.datetime(2017,6,1,5,35,0) : [random.choice(["Transitions/sunrise.yml","Transitions/sunrise_hebrew.yml"]), "wish.yml"], datetime.datetime(2017,6,1,5,45,0) : ["Transitions/after_sunrise.yml", "exile.yml"] \
                            }
