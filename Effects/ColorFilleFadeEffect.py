...
class ColorFillFadeEffect(Effect):
    def __init__(self, indexes, fade_time_percent):
    ...
    def apply(self, time_percent, parent_array):
        ...
        for i in range(0, len(self.indexes)):
            ...
            color = Colors.hls_to_rgb(time_percent, 1.0, time_to_end_percent * time_to_end_percent) if i > from_pixel and i < to_pixel else [0,0,0]
